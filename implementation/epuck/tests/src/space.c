...
*/
    ...
    USE_SPACE(./main.c:22,double,victim_phi,[1]," = -1;");
    USE_SPACE(./main.c:23,int,victim_phi_updated,[1]," = 0;");
    USE_SPACE(./main.c:25,int,state,[1]," = STATE_STARTUP;");
    USE_SPACE(./main.c:27,int,loop_counter,[1]," = 0;");
    USE_SPACE(./main.c:28,int,loop_freq,[1]," = 0;");
    USE_SPACE(./main.c:30,int,proximity_raw,[11][8],"[11][8] = {0};");
    USE_SPACE(./main.c:31,int,proximity_position,[1]," = 0;");
    USE_SPACE(./main.c:33,double,proximity,[8],"[8] = {0};");
    USE_SPACE(./main.c:35,int,do_reset,[1]," = 0;");
    USE_SPACE(./main.c:36,int,do_calibration,[1]," = 0;");
    USE_SPACE(./main.c:38,TinBot,bot,[1],";");
    USE_SPACE(./main.c:40,char,my_com_addr,[1],";");
    USE_SPACE(./main.c:43,char,mode,[1]," = 0;");
    USE_SPACE(./main.c:47,TinTask,update_ext_data_task,[1],";");
    USE_SPACE(./main.c:55,TinTask,proximity_filter_task,[1],";");
    USE_SPACE(./main.c:66,TinTask,reset_loop_counter_task,[1],";");
    USE_SPACE(./main.c:75,TinTask,send_heartbeat_task,[1],";");
    USE_SPACE(./main.c:93,TinPackage,response,[1]," = {NULL, NULL, CMD_HELLO, 0, NULL, NULL};");
    USE_SPACE(./main.c:94,char,data,[4 + 2 + 2],"[4 + 2 + 2] __attribute__ ((aligned (4)));");
    USE_SPACE(./main.c:131,TinPackage,response,[1]," = {NULL, NULL, CMD_DEBUG_INFO, 0, NULL, NULL};");
    USE_SPACE(./main.c:132,char,data,[4 * 11 + 2 + 6 + 1],"[4 * 11 + 2 + 6 + 1] __attribute__ ((aligned (4)));");
    USE_SPACE(./main.c:166,TinPackage,response,[1]," = {NULL, NULL, CMD_T2T_UPDATE_MAP, 0, NULL, NULL};");
    USE_SPACE(./main.c:167,char,data,[68],"[68] __attribute__ ((aligned (4)));");
    USE_SPACE(./main.c:350,int,tmp_pickup_data,[1]," = 0;");
    USE_SPACE(./main.c:351,int,state,[1]," = 0;");
    ...
    USE_SPACE(./src/path-finder.c:140,int,APPROX_RADIUS,[1]," = 2;");
    USE_SPACE(./src/path-exec.c:24,double,PE_MAX_STRAY,[1]," = 10;");
    USE_SPACE(./src/victim-direction.c:27,double,VD_MIN_ON,[1]," = 9.0 / 360.0;");
    USE_SPACE(./src/bellman-ford/bellman-ford.c:11,BellmanFordLocals,locals,[1],";");
