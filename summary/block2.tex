...
\begin{description}
	...
	\item[Stability] Eigenvalues' real part positive $\rightarrow$ asymptotically
	stable\\ 
	non-negative $\rightarrow$ stable\\
	$A$ invertible $\rightarrow$ only one equilibrium.\\
	...
	TODO
	\MAX{Left off: PID Controller, lecture 6.}
\end{description}